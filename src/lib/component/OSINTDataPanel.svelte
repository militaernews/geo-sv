...
<div class="absolute bottom-4 left-4 z-[300] bg-base-800 rounded-lg shadow-2xl border border-base-700 w-96 max-h-[70vh] overflow-hidden flex flex-col">
	<!-- Header -->
	...
	<div class="flex-1 overflow-y-auto p-4 space-y-4">
		{#if activeTab === 'overview'}
			<div class="space-y-3">
				<div class="grid grid-cols-2 gap-2">
					<div class="p-3 bg-base-700 rounded border border-base-600">
		...
		{:else if activeTab === 'sources'}
			<div class="space-y-3">
				<div class="p-3 bg-base-700 rounded border border-base-600 space-y-2">
