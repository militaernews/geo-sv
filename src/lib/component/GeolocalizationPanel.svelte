...
<div class="absolute bottom-4 right-4 z-[300] bg-slate-800 rounded-lg shadow-2xl border border-slate-700 w-96 max-h-[70vh] overflow-hidden flex flex-col">
	<!-- Header -->
	...
	<div class="flex-1 overflow-y-auto p-4 space-y-4">
			...
			<div class="space-y-3">
				...
				{#if imageUrl}
					<div class="space-y-2">
						...
						<div class="mt-3 p-2 bg-slate-700 rounded border border-slate-600">
				...
				{:else}
					<div class="p-4 bg-slate-700/50 rounded border border-slate-600 text-center text-xs opacity-60">
						No image selected
					</div>
				{/if}
			</div>
		{:else if selectedTool === 'sun'}
			<div class="space-y-3">
				...
				{#if showSunInfo}
					<div class="space-y-2 p-3 bg-slate-700 rounded border border-slate-600">
		...
		{:else if selectedTool === 'compass'}
			<div class="space-y-3">
				...
				<div class="p-3 bg-slate-700 rounded border border-slate-600 text-center text-xs">
